...
!#endif 
  ...
  ! have to point ev
   ...
   if (.not.(obj%eigenvalues_only)) then
     ...
     call check_allocate_f("elpa1_template: q_dummy", 582,  istat,  errorMessage)
     q_actual => q_dummy
   endif

   allocate(e(na), tau(na), stat=istat, errmsg=errorMessage)
   call check_allocate_f("elpa1_template: e, tau", 596,  istat,  errorMessage)
...
!        global_index = indxl2g(i, nblk, my_prow, 0, np_rows)
   ...
   call check_deallocate_f("elpa1_template: e, tau", 798,  istat,  errorMessage)

   if (obj%eigenvalues_only) then
     deallocate(q_dummy, stat=istat, errmsg=errorMessage)
     call check_deallocate_f("elpa1_template: q_dummy", 802,  istat,  errorMessage)
   endif
   ...
   call check_deallocate_f("elpa1_template: e", 902,  istat,  errorMessage)
...
!#endif 
  ...
  real(kind=rck), pointer                                   :: q(:,:)
   ...
   call check_allocate_f("elpa1_template: aIntern", 389,  istat,  errorMessage)

   a       => aIntern(1:matrixRows,1:matrixCols)

   allocate(evIntern(1:obj%na), stat=istat, errmsg=errorMessage)
   call check_allocate_f("elpa1_template: evIntern", 394,  istat,  errorMessage)
   ev      => evIntern(1:obj%na)

   if (present(qExtern)) then
     allocate(qIntern(1:matrixRows,1:matrixCols), stat=istat, errmsg=errorMessage)
     call check_allocate_f("elpa1_template: qIntern", 403,  istat,  errorMessage)
   endif
...
!        global_index = indxl2g(i, nblk, my_prow, 0, np_rows)
   ...
   ! restore original OpenMP settings
     ...
     call check_deallocate_f("elpa1_template: aIntern", 874,  istat,  errorMessage)
     !deallocate(evIntern)
     nullify(evIntern)
     if (present(qExtern)) then
       deallocate(qIntern, stat=istat, errmsg=errorMessage)
       call check_deallocate_f("elpa1_template: qIntern", 879,  istat,  errorMessage)
     endif
...
!#endif 
  ...
  ! have to point ev
   ...
   call check_allocate_f("elpa1_template: q_real", 593,  istat,  errorMessage)
   allocate(e(na), tau(na), stat=istat, errmsg=errorMessage)
   call check_allocate_f("elpa1_template: e, tau", 596,  istat,  errorMessage)
...
!        global_index = indxl2g(i, nblk, my_prow, 0, np_rows)
    ...
    call check_deallocate_f("elpa1_template: q_real", 794,  istat,  errorMessage)
...
!#endif 
  ...
  real(kind=rck), pointer                                   :: q(:,:)
   ...
   if (present(qExtern)) then
     ...
     call check_allocate_f("elpa1_template: qIntern", 400,  istat,  errorMessage)
   endif
