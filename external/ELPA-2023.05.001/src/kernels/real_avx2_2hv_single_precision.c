...
# 1 "../src/elpa2/kernels/real_avx2_2hv_single_precision.c"
...
# 1 "../src/elpa2/kernels/real_avx2_2hv_single_precision.c" 2
...
# 1 "./config-f90.h" 1
# 48 "../src/elpa2/kernels/real_avx2_2hv_single_precision.c" 2
...
# 54 "../src/elpa2/kernels/real_avx2_2hv_single_precision.c" 2
...
# 315 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"

# 328 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 1980 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"

# 1989 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 2006 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"

# 2015 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 2412 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 3194 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 3850 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 3906 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 5113 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 5724 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 6420 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
    ...
    q4 = _mm256_load_ps(&q[(nb*ldq)+3*8]);
    q5 = _mm256_load_ps(&q[(nb*ldq)+4*8]);
# 6435 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    x1 = _mm256_add_ps(  x1, _mm256_mul_ps(  q1,h1));
    x2 = _mm256_add_ps(  x2, _mm256_mul_ps(  q2,h1));
    x3 = _mm256_add_ps(  x3, _mm256_mul_ps(  q3,h1));
    x4 = _mm256_add_ps(  x4, _mm256_mul_ps(  q4,h1));
...
# 7022 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   ...
   __m256 tau1 = _mm256_broadcast_ss(hh);
   __m256 tau2 = _mm256_broadcast_ss(&hh[ldh]);
# 7034 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 7089 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 7314 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   ...
   q4 = _mm256_load_ps(&q[ldq+3*8]);
   q5 = _mm256_load_ps(&q[ldq+4*8]);
# 7329 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   q1 = _mm256_add_ps(  q1, _mm256_add_ps(  x1, _mm256_mul_ps(  y1, h2)));
   q2 = _mm256_add_ps(  q2, _mm256_add_ps(  x2, _mm256_mul_ps(  y2, h2)));
   q3 = _mm256_add_ps(  q3, _mm256_add_ps(  x3, _mm256_mul_ps(  y3, h2)));
   q4 = _mm256_add_ps(  q4, _mm256_add_ps(  x4, _mm256_mul_ps(  y4, h2)));
...
# 8189 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 8759 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 9366 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 9380 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    x1 = _mm256_add_ps(  x1, _mm256_mul_ps(  q1,h1));
    x2 = _mm256_add_ps(  x2, _mm256_mul_ps(  q2,h1));
    x3 = _mm256_add_ps(  x3, _mm256_mul_ps(  q3,h1));
    x4 = _mm256_add_ps(  x4, _mm256_mul_ps(  q4,h1));
...
# 9926 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   ...
   __m256 tau1 = _mm256_broadcast_ss(hh);
   __m256 tau2 = _mm256_broadcast_ss(&hh[ldh]);
# 9938 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 9993 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 10028 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 10974 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 11501 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 12021 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 12536 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   ...
   __m256 tau1 = _mm256_broadcast_ss(hh);
   __m256 tau2 = _mm256_broadcast_ss(&hh[ldh]);
# 12548 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 12603 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 13490 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 13978 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 13998 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    ...
    __m256 h2;
# 14008 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    __m256 q1 = _mm256_load_ps(q);
    __m256 y1 = _mm256_add_ps(  q1, _mm256_mul_ps(  x1, h1));
    __m256 q2 = _mm256_load_ps(&q[8]);
    __m256 y2 = _mm256_add_ps(  q2, _mm256_mul_ps(  x2, h1));
...
# 14302 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
        ...
        q1 = _mm256_load_ps(&q[i*ldq]);
        q2 = _mm256_load_ps(&q[(i*ldq)+8]);
# 14314 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
        x1 = _mm256_add_ps(  x1, _mm256_mul_ps(  q1,h1));
        y1 = _mm256_add_ps(  y1, _mm256_mul_ps(  q1,h2));
        x2 = _mm256_add_ps(  x2, _mm256_mul_ps(  q2,h1));
        y2 = _mm256_add_ps(  y2, _mm256_mul_ps(  q2,h2));
...
# 14412 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 14883 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   ...
   __m256 tau1 = _mm256_broadcast_ss(hh);
   __m256 tau2 = _mm256_broadcast_ss(&hh[ldh]);
# 14895 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 14950 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 15721 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 16168 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 16516 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
    h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 16946 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   ...
   __m256 tau1 = _mm256_broadcast_ss(hh);
   __m256 tau2 = _mm256_broadcast_ss(&hh[ldh]);
# 16958 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 17014 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
...
# 17674 "../src/elpa2/kernels/real_128bit_256bit_512bit_BLOCK_template.c"
   h1 = _mm256_broadcast_ss(&hh[nb-(2-1)]);
...
# 55 "../src/elpa2/kernels/real_avx2_2hv_single_precision.c" 2
