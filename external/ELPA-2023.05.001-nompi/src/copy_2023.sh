elpa_dir=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_generic
for file in \
  aligned_mem.f90                       \
  check_for_gpu.f90                     \
...
elpa_dir=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_cuda
for file in \
  mod_cuda.f90 \
...
elpa_dir=/scratch/ukh0001/elpa-2023.05.001_c_nompi/src
for file in \
  elpa_c_interface.c
do
echo $file
...
elpa_dir=/scratch/ukh0001/elpa-2023.05.001_c_nompi/src/ftimings
for file in \
  highwater_mark.c \
  resident_set_size.c \
  time.c \
...
elpa_dir=/scratch/ukh0001/elpa-2023.05.001_c_nompi/elpa
mkdir elpa
...
elpa_dir=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_generic
elpa_dir_avx=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_avx
elpa_dir_avx2=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_avx2
elpa_dir_avx512=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_avx512
elpa_dir_cuda=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_cuda
...
elpa_dir_cuda_src=/scratch/ukh0001/elpa-2023.05.001_c_nompi/src/GPU/CUDA
cp $elpa_dir_cuda_src/*.cu .

elpa_dir_elpa=/scratch/ukh0001/elpa-2023.05.001_c_nompi/build_generic/elpa
cp -r $elpa_dir_elpa .
