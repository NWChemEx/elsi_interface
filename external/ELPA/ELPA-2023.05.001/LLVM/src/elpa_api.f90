...
module elpa_api
 ...
 interface
  ...
  integer, private, parameter :: current_api_version  = 20231705  !< Definition of the current API version
...
!      complex(kind=c_double) :: a(self%local_nrows,*), b(nrows_b,*), c(nrows_c,*)
!#else
!      complex(kind=c_double) :: a(self%local_nrows,self%local_ncols), b(nrows_b,ncols_b), c(nrows_c,ncols_c)
!#endif
...
!      complex(kind=c_float) :: a(self%local_nrows,*), b(nrows_b,*), c(nrows_c,*)
!#else
!      complex(kind=c_float) :: a(self%local_nrows,self%local_ncols), b(nrows_b,ncols_b), c(nrows_c,ncols_c)
!#endif
